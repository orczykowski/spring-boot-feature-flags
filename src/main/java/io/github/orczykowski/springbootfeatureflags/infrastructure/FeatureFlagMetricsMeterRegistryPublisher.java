...
public class FeatureFlagMetricsMeterRegistryPublisher implements FeatureFlagMetricsPublisher {
    ...
    public FeatureFlagMetricsMeterRegistryPublisher(final MeterRegistry meterRegistry) {
    ...
    @Override
    public void reportVerification(final FeatureFlagName flagName, final FeatureFlagUser user, final Boolean verificationResult) {
    ...
    @Override
    public void reportFlagNotFound() {
