...
public class FeatureFlagPresenterApi {
    private final FeatureFlagEnabledFeatureFlagNameProvider enabledFeatureFlagNameProvider;

    public FeatureFlagPresenterApi(final FeatureFlagEnabledFeatureFlagNameProvider enabledFeatureFlagNameProvider) {
    ...
    FeatureFlagsResponse getFeatureFlags() {
        return enabledFeatureFlagNameProvider.provide()
